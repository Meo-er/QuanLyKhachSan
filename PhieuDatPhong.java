...
public class PhieuDatPhong {
    ...
    public void setNgay(LocalDate date) {
        this.ngay = date;
    }
    ...
    public void xuat() {
        ...
        if (ngay != null) {
            System.out.print("Ngay dat phong:" + ngay);
        } else {
            System.out.println("Ngay dat phong: chua co");
        }
        System.out.println("Ma khach hang:" + maKhachHang + "\tMa nhan vien: " + maNhanVien + "\tSo luong phong: "
                + sl_Phong + "\tTong tien: " + tongTien);
        System.out.println("--- //---//---//---//---//---");
    }
